...
class WeatherApp extends StatefulWidget {
  WeatherApp({super.key, required this.LocationWeather});
                  ...
                  Padding(
                      ...
                      child: IconButton(
                          onPressed: () async {
                            ...
                            if (typedName != null) {
                              var cityWeather =
                                  await FutureData().getCityData(typedName);

                              getWeatherData =
                                  cityWeather as Future<WeatherData>;
                            }
                          },
              ...
              default:
                if (snapshot.hasError) {
                  ...
                  String getFormattedDate(int index) {
                    final DateTime date =
                        DateTime.parse(data.forecast.forecastday[index].date);
